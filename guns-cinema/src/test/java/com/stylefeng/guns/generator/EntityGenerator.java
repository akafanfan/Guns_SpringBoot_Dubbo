...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("D:\\Documents\\IdeaProjects\\guns\\guns-cinema\\src\\main\\java");//这里写你自己的java目录
        gc.setFileOverride(true);//是否覆盖
        gc.setActiveRecord(true);
        gc.setEnableCache(false);// XML 二级缓存
        gc.setBaseResultMap(true);// XML ResultMap
        gc.setBaseColumnList(false);// XML columList
        gc.setAuthor("FanFanStudio");
...
//        strategy.setInclude(new String[]{"F_banner_t","F_cat_dict_t","F_source_dict_t","F_year_dict_t","F_film_t","F_film_info_t","F_actor_t"});
//        strategy.setInclude(new String[]{"f_film_actor_t"});
